...
public class KafkaConfig {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        configs.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, io.cloudevents.kafka.CloudEventSerializer.class);
        return configs;
    }
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        configs.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, io.cloudevents.kafka.CloudEventDeserializer.class);
